...
public class PresentationJFramePageAcceuil extends javax.swing.JFrame {
    ...
    public void setFrame() {
            ...
            labelResilierContrat.setEnabled(false);
    }
    /*--------------------------------------------------------------------------
    ...
    private void setRadioButtonsDeLaPageDesContrats(){
        ...
        radioButtonrechercheAvecFournisseur.setSelected(false);
        ...
        radioButtonProduitParNumRef.setSelected(false);
    ...
    private void setBaresDeRechreches(){
        ...
        comboBoxRechercheContratParFournisseur.setEnabled(false);
        ...
        fieldRechercheProduitParNumRef.setEnabled(false);
    }
    /*--------------------------------------------------------------------------
    ...
    public void setTableDesProduits(String[][] infosProduits){
        if (infosProduits == null) {
			...
			for (int i = 0; i < infosProduits.length; i++) {
				Object[] ligne = { infosProduits[i][0], infosProduits[i][1]};
				model.insertRow(i, ligne);
			}
		}
    ...
    public void setComboBoxDesFournisseurs(String[][] infosFournisseurs) {
        ...
        comboBoxRechercheContratParFournisseur.removeAllItems();

        // Remplir la comboBox avec les données des fournisseurs
        for (int i = 0; i < infosFournisseurs.length; i++) {
            if (infosFournisseurs[i].length > 1) { // Vérifie que la colonne 1 existe
                comboBoxRechercheContratParFournisseur.addItem(infosFournisseurs[i][0]);
            }
        }
    }
    ...
    private void initJDialogResilierContrat(String numContrat){
        // Création du JDialog
        JDialog dialogResiliationContrat = new JDialog(this, "Résilier le Contrat", true);
        dialogResiliationContrat.setSize(400, 200);
        dialogResiliationContrat.setLayout(new BorderLayout());

        // Message d'avertissement
        JLabel messageLabel = new JLabel("<html>Souhaitez-vous résilier ce contrat?<br><br>NB: Une fois le contrat résilié, vous ne pourrez plus revenir en arrière. Le contrat sera supprimé définitivement de votre base de données!</html>");
        messageLabel.setHorizontalAlignment(SwingConstants.CENTER);
        dialogResiliationContrat.add(messageLabel, BorderLayout.CENTER);

        // Création des boutons
        JButton annulerButton = new JButton("Annuler");
        JButton resilierButton = new JButton("Résilier");

        // Action pour le bouton Annuler
        annulerButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                dialogResiliationContrat.dispose();
            }
        });

        // Action pour le bouton Résilier 
        resilierButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (dialog.handelEventBoutonResilierContart(numContrat)) {
                    labelMsgImportantMesContrats.setText("Le contrat "+ numContrat +" n'est plus disponible.");
                    //Actualiser la liste des contrats et des fournisseurs et des produits
                    ...
                    labelMsgImportantMesContrats.setText("Erreur lors de la resiliation du contrat : "+ numContrat);
                }
        ...
        // Styliser le bouton Résilier en rouge
        resilierButton.setForeground(Color.WHITE);
        resilierButton.setBackground(Color.RED);

        // Ajouter les boutons au dialog
        JPanel buttonPanel = new JPanel();
        buttonPanel.add(annulerButton);
        buttonPanel.add(resilierButton);
        dialogResiliationContrat.add(buttonPanel, BorderLayout.SOUTH);

        // Positionner le dialog au centre de l'écran
        dialogResiliationContrat.setLocationRelativeTo(null);
        dialogResiliationContrat.setVisible(true);
    }

    public String getNumContrat(){
	return tableDesFournisseurs.getValueAt(tableDesProduits.getSelectedRow(), 1).toString();  
    }
    ...
    private void initComponents() {
        ...
        radioButtonrechercheAvecFournisseur = new javax.swing.JRadioButton();
        radioButtonDateDebut = new javax.swing.JRadioButton();
        radioButtonNumContrat = new javax.swing.JRadioButton();
        comboBoxRechercheContratParFournisseur = new javax.swing.JComboBox<>();
        ...
        labelResilierContrat = new javax.swing.JLabel();
        ...
        radioButtonProduitParNumRef = new javax.swing.JRadioButton();
        fieldRechercheProduitParNumRef = new javax.swing.JTextField();
        ...
        radioButtonrechercheAvecFournisseur.setBackground(new java.awt.Color(149, 190, 246));
        radioButtonrechercheAvecFournisseur.setForeground(new java.awt.Color(255, 255, 255));
        radioButtonrechercheAvecFournisseur.setText("Rechercher par numTel fournisseur");
        radioButtonrechercheAvecFournisseur.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radioButtonrechercheAvecFournisseurActionPerformed(evt);
            }
        });
        ...
        comboBoxRechercheContratParFournisseur.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        panelHeadPageAcceuil1Layout.setHorizontalGroup(
            ...
            .addGroup(panelHeadPageAcceuil1Layout.createSequentialGroup()
                ...
                .addGroup(panelHeadPageAcceuil1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelHeadPageAcceuil1Layout.createSequentialGroup()
                        .addGap(98, 98, 98)
                        .addComponent(comboBoxRechercheContratParFournisseur, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(panelHeadPageAcceuil1Layout.createSequentialGroup()
                        .addGap(89, 89, 89)
                        .addComponent(radioButtonrechercheAvecFournisseur, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
        panelHeadPageAcceuil1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelHeadPageAcceuil1Layout.createSequentialGroup()
                ...
                .addGap(78, 78, 78)
                .addGroup(panelHeadPageAcceuil1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(radioButtonrechercheAvecFournisseur)
                ...
                .addGroup(panelHeadPageAcceuil1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(comboBoxRechercheContratParFournisseur, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        tableDesContrats.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Num Contrat", "Debut", "Fin ", "Fournisseur"
            }
        ) {
        ...
        labelResilierContrat.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        labelResilierContrat.setForeground(new java.awt.Color(255, 0, 51));
        labelResilierContrat.setText("Résilier ce contrat");
        labelResilierContrat.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        labelResilierContrat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                labelResilierContratMouseClicked(evt);
            }
        });
                ...
                .addGroup(panelMesContartsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelMesContartsLayout.createSequentialGroup()
                        ...
                        .addGroup(panelMesContartsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(panelMesContartsLayout.createSequentialGroup()
                                .addGap(59, 59, 59)
                                .addComponent(labelResilierContrat)))
                        .addGap(6, 6, 6))
        ...
        tableDesFournisseurs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Num de telephone", "Num siret", "Nom d'entreprise"
            }
        ) {
            Class[] types = new Class [] {
        ...
        radioButtonProduitParNumRef.setBackground(new java.awt.Color(149, 190, 246));
        radioButtonProduitParNumRef.setForeground(new java.awt.Color(255, 255, 255));
        radioButtonProduitParNumRef.setText("Recherche par Num ref");
        radioButtonProduitParNumRef.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radioButtonProduitParNumRefActionPerformed(evt);
            }
        });

        fieldRechercheProduitParNumRef.setText("Num ref ...");
        fieldRechercheProduitParNumRef.setToolTipText("");
        fieldRechercheProduitParNumRef.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                fieldRechercheProduitParNumRefFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                fieldRechercheProduitParNumRefFocusLost(evt);
            }
        });
        fieldRechercheProduitParNumRef.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fieldRechercheProduitParNumRefActionPerformed(evt);
            }
        });
        ...
        panelHeadPageAcceuil3Layout.setHorizontalGroup(
            ...
            .addGroup(panelHeadPageAcceuil3Layout.createSequentialGroup()
                ...
                .addGap(232, 232, 232)
                .addGroup(panelHeadPageAcceuil3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(radioButtonProduitParNumRef)
                    .addComponent(fieldRechercheProduitParNumRef, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        panelHeadPageAcceuil3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelHeadPageAcceuil3Layout.createSequentialGroup()
                ...
                .addGroup(panelHeadPageAcceuil3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(fieldRechercheProduitParNumRef, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31)
        ...
        tableDesProduits.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom du produit", "Num de référence "
            }
        ) {
            Class[] types = new Class [] {
    ...
    private void buttonRechercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRechercherActionPerformed
        ...
        if (radioButtonNumContrat.isSelected() && 
            ...
            buttonEffacerFiltresContrat.setVisible(true);
        } else if (radioButtonrechercheAvecFournisseur.isSelected() &&
                !(motCle = comboBoxRechercheContratParFournisseur.getItemAt(comboBoxRechercheContratParFournisseur.getSelectedIndex())).equals("") &&
                !(motCle = comboBoxRechercheContratParFournisseur.getItemAt(comboBoxRechercheContratParFournisseur.getSelectedIndex())).equals("Date de fin ...")){
            System.out.println("presentation.PresentationJFramePageAcceuil.buttonRechercherActionPerformed() "+ motCle);
            dialog.handleEventButtonRechercherContart(motCle, "Fournisseur");
            buttonEffacerFiltresContrat.setVisible(true);
        } else {
            //ne rien faire
        }
    ...
    private void radioButtonrechercheAvecFournisseurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonrechercheAvecFournisseurActionPerformed
        comboBoxRechercheContratParFournisseur.setEnabled(true);
        fieldrchercheAvecdateDebuContrat.setEnabled(false);
        fieldrchercheAvecNumContrat.setEnabled(false);
        radioButtonDateDebut.setSelected(false);
        radioButtonNumContrat.setSelected(false);
        
        if (!radioButtonrechercheAvecFournisseur.isSelected()) {
            comboBoxRechercheContratParFournisseur.setEnabled(false);
        }
    }//GEN-LAST:event_radioButtonrechercheAvecFournisseurActionPerformed
    ...
    private void buttonEffacerFiltresContratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEffacerFiltresContratActionPerformed
        ...
        fieldrchercheAvecNumContrat.setText("Num contrat ...");
        fieldrchercheAvecdateDebuContrat.setText("Date de début ...");
        comboBoxRechercheContratParFournisseur.setSelectedIndex(0);
    ...
    private void tableDesContratsFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tableDesContratsFocusGained
        ...
        labelResilierContrat.setEnabled(true);
    ...
    private void radioButtonProduitParNumRefActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioButtonProduitParNumRefActionPerformed
        radioButtonProduitParNom.setSelected(false);
        fieldRechercheProduitParNumRef.setEnabled(true);
        fieldRechercheProduitParNom.setEnabled(false);
        
        if (!radioButtonProduitParNumRef.isSelected()) {
            fieldRechercheProduitParNumRef.setEnabled(false);
        }
    }//GEN-LAST:event_radioButtonProduitParNumRefActionPerformed
    ...
    private void buttonRechercher2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRechercher2ActionPerformed
        ...
        } else if (radioButtonProduitParNumRef.isSelected()&& 
                !(motCle = fieldRechercheProduitParNumRef.getText()).equals("") &&
                !(motCle = fieldRechercheProduitParNumRef.getText()).equals("Num ref ...")){
        	
            dialog.handleEventButtonRechercherProduit(motCle, "Num ref");
            buttonEffacerFiltresProduit.setVisible(true);
        } else {
            //ne rien faire
        }
    ...
    private void labelResilierContratMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelResilierContratMouseClicked
        int numLigneSelectionee = tableDesContrats.getSelectedRow();
	String numContrat = tableDesContrats.getValueAt(numLigneSelectionee, 0).toString();
        initJDialogResilierContrat(numContrat);
    }//GEN-LAST:event_labelResilierContratMouseClicked

    private void fieldRechercheProduitParNumRefFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_fieldRechercheProduitParNumRefFocusGained
        if (fieldRechercheProduitParNumRef.getText().equals("Num ref ...")) {
            fieldRechercheProduitParNumRef.setText("");
        }
    }//GEN-LAST:event_fieldRechercheProduitParNumRefFocusGained

    private void fieldRechercheProduitParNumRefFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_fieldRechercheProduitParNumRefFocusLost
        if (fieldRechercheProduitParNumRef.getText().equals("")) {
            fieldRechercheProduitParNumRef.setText("Num ref ...");
        }
    }//GEN-LAST:event_fieldRechercheProduitParNumRefFocusLost

    private void fieldRechercheProduitParNumRefActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fieldRechercheProduitParNumRefActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fieldRechercheProduitParNumRefActionPerformed
    ...
    private javax.swing.JComboBox<String> comboBoxRechercheContratParFournisseur;
    private javax.swing.JTextField fieldRechercheProduitParNom;
    private javax.swing.JTextField fieldRechercheProduitParNumRef;
    ...
    private javax.swing.JLabel labelResilierContrat;
    ...
    private javax.swing.JRadioButton radioButtonProduitParNumRef;
    private javax.swing.JRadioButton radioButtonrechercheAvecFournisseur;
