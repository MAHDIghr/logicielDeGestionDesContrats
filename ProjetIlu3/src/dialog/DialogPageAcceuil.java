...
public class DialogPageAcceuil {
    ...
    public void handelEventBoutonEtablirNouveauContrat() {
        dialogNouveauContrat.setDialog(frameAcceuil, this);
    }
    
    public boolean handelEventBoutonResilierContart(String numContrat){
        return interfacePageAcceuil.resilierContrat(numContrat);
    }
    /*--------------------------------------------------------------------------
    ----------------------------------------------------------------------------*/
