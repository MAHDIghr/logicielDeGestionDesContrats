...
public class DialogNouveauContrat {
	...
	public void setDialog(PresentationJFramePageAcceuil frameParente) {
		intrfNouveauContrat = new InterfaceNouveauContrat();
                dialogPageAcceuil = new DialogPageAcceuil();
	 ...
	 */
	public void ajouterUnNouveauFournisseur(String numTelFournisseur, String nomFournisseur,
			String nomEntreprise) {
		intrfNouveauContrat.enregistrerUnNouveauFournisseur(numTelFournisseur, nomFournisseur, nomEntreprise);
